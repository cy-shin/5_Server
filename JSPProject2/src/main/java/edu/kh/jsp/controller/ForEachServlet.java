...
public class ForEachServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		pList.add(new Person("김길동", 34, "서울시 종로구"));
		pList.add(new Person("이길동", 43, "서울시 서대문구"));
		pList.add(new Person("박길동", 52, "서울시 송파구"));
		pList.add(new Person("최길동", 61, "서울시 성동구"));
		
		req.setAttribute("pList", pList); // req에 값 세팅
