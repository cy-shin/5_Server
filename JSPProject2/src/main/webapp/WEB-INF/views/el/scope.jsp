...
<body>
    <pre>
        ...
        (세션에 로그인 정보를 기록해둠
            -> 브라우저가 종료되거나, 로그아웃 되기 전 까지
               계속 로그인 상태가 유지됨.)

        4) application : 하나의 웹 애플리케이션당 1개만 생성되는 객체(java의 static과 유사함) 
        )
            -> 서버 시작 시 생성되며, 종료 시까지 유지됨
            -> 누구든지 사용 가능
        ...
        ************************
        ...
        -> setAttribute("key", value)로 내장 객체가 값을 세팅할 때
           ...
           \${key} 로 작성하는 경우, 범위가 작은 내장 객체가 높은 우선순위를 가진다.
